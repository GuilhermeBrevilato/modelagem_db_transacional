...
2. **modelagem**
   ...
   - `modelo_logico`
     - [`modelo_logico.pdf`]([http://github.com/GuilhermeBrevilato/modelagem_db_transacional/blob/main/Modelo%20L%C3%B3gico.pdf](https://github.com/GuilhermeBrevilato/modelagem_db_transacional_ecommerce/blob/main/modelo_logico.pdf))
